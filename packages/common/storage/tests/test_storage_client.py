...
from ..client import StorageClient, StorageConnectionError, StorageError
...
class TestStorageClient:
    ...
    def test_upload_file_s3_error(self, mock_boto_client):
        ...
        with pytest.raises(StorageError, match="Failed to upload file"):
            client.upload_file(
                file_obj=file_obj, key="designs/test.png", content_type="image/png"
            )
    ...
    def test_generate_signed_url_success(self, mock_boto_client):
        ...
        mock_s3.generate_presigned_url.return_value = (
            "https://s3.amazonaws.com/test-bucket/designs/test.png?signature=abc123"
        )
        mock_boto_client.return_value = mock_s3
        ...
        # Act
        url = client.generate_signed_url(key="designs/test.png", expiry_hours=24)
    ...
    def test_connection_error_handling(self):
        ...
        # Act & Assert
        with pytest.raises(
            StorageConnectionError, match="Invalid storage configuration"
        ):
            StorageClient(
    ...
    def test_file_exists_check(self, mock_boto_client):
        ...
        mock_s3.head_object.assert_called_once_with(
            Bucket="test-bucket", Key="designs/test.png"
        )
