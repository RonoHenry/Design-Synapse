...
class FileProcessingError(KnowledgeServiceError):
    ...
    def __init__(
        self, filename: str, message: str = None, details: Dict[str, Any] = None
    ):
        super().__init__(
...
class UnsupportedFileTypeError(KnowledgeServiceError):
    ...
    def __init__(self, filename: str, supported_types: list = None):
        super().__init__(
            ...
            status_code=400,
            details={"filename": filename, "supported_types": supported_types or []},
        )
...
class BatchProcessingError(KnowledgeServiceError):
    ...
    def __init__(
        self, job_id: str = None, message: str = None, details: Dict[str, Any] = None
    ):
        super().__init__(
