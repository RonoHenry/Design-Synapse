...
from common.config import BaseServiceConfig, DatabaseConfig, LLMConfig, Environment
...
class DesignServiceConfig:
    ...
    def __init__(self):
        ...
        self.knowledge_service_url: str = os.getenv("KNOWLEDGE_SERVICE_URL", "http://localhost:8002")
