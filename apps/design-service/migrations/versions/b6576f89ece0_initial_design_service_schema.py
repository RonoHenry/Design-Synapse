...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_designs_building_type"), "designs", ["building_type"], unique=False
    )
    op.create_index(
        op.f("ix_designs_created_by"), "designs", ["created_by"], unique=False
    )
    op.create_index(
        op.f("ix_designs_project_id"), "designs", ["project_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.Column(
            "is_edited", sa.Boolean(), server_default=sa.text("0"), nullable=False
        ),
