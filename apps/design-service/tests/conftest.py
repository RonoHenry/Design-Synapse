...
from common.testing.fixtures import (event_loop, mock_http_service,
                                     mock_llm_service)
...
def db_session(db_engine):
    ...
    with create_test_session(db_engine, Base) as session:
        ...
        from .factories import (DesignCommentFactory, DesignFactory,
...
def client(db_session, test_user_id, mock_llm_client, mock_project_client):
    ...
    from src.api.v1.routes.comments import \
        get_project_client as get_project_client_comments
    from src.api.v1.routes.designs import get_llm_client, get_project_client
    from src.api.v1.routes.export import \
        get_project_client as get_project_client_export
    from src.api.v1.routes.files import \
        get_project_client as get_project_client_files
    ...
    from src.api.v1.routes.validations import \
        get_project_client as get_project_client_validations
    ...
    app.dependency_overrides[
        get_project_client_validations
    ] = override_get_project_client
    app.dependency_overrides[get_llm_client_optimizations] = override_get_llm_client
    app.dependency_overrides[
        get_project_client_optimizations
    ] = override_get_project_client
...
@pytest.fixture
def client_no_project_access(
    db_session, test_user_id, mock_llm_client, mock_project_client_access_denied
):
    ...
    app.dependency_overrides[
        get_project_client_validations
    ] = override_get_project_client_denied
    app.dependency_overrides[get_llm_client_optimizations] = override_get_llm_client
    app.dependency_overrides[
        get_project_client_optimizations
    ] = override_get_project_client_denied
    app.dependency_overrides[
        get_project_client_comments
    ] = override_get_project_client_denied
    app.dependency_overrides[
        get_project_client_export
    ] = override_get_project_client_denied
    app.dependency_overrides[
        get_project_client_files
    ] = override_get_project_client_denied
...
def mock_llm_client():
    ...
    mock_client.generate_design_specification = AsyncMock(
        return_value={
            "specification": {
                "building_info": {
                    "type": "residential",
    ...
    mock_client.generate_optimizations = AsyncMock(
        return_value={
            "optimizations": [
                {
...
def mock_project_client():
    ...
    mock_client.get_project_details = AsyncMock(
        return_value={
            "id": 1,
            "name": "Test Project",
...
def mock_user_client():
    ...
    mock_client.get_user_details = AsyncMock(
        return_value={
            "id": 1,
...
def mock_auth_user(monkeypatch):
    ...
    monkeypatch.setattr(
        "src.api.dependencies.get_current_user_id", mock_get_current_user_id
    )
    return 1
