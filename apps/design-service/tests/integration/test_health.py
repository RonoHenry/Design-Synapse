...
class TestReadinessEndpoint:
    ...
    def test_ready_checks_database_connectivity(self, client):
        ...
        with patch("src.main.check_database_health") as mock_health, patch(
            "src.main.get_settings"
        ) as mock_settings, patch("src.main.check_ai_service_health") as mock_ai_health:
            # Mock settings
    ...
    def test_ready_checks_ai_service_availability(self, client):
        ...
        with patch("src.main.check_database_health") as mock_db_health, patch(
            "src.main.check_ai_service_health"
        ) as mock_ai_health, patch("src.main.get_settings") as mock_settings:
            # Mock settings
            mock_settings.return_value = create_mock_config()
