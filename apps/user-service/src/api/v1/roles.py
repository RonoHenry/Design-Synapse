...
from src.api.dependencies import has_role, get_current_user
...
@router.post("/users/{user_id}/roles/{role_name}", response_model=RoleAssignmentResponse)
...
@router.delete("/users/{user_id}/roles/{role_name}", response_model=RoleAssignmentResponse)
