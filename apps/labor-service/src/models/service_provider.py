...
class ProviderSkill(BaseModel):
    ...
    skill = relationship(
        "Skill",
        back_populates="provider_skills"
    )
    ...
    def __repr__(self):
        return f"<ProviderSkill(provider_id={self.provider_id}, skill_id={self.skill_id})>"
