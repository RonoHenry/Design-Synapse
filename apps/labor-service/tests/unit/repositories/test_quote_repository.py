...
class TestQuoteRepository:
    ...
    def test_find_by_request_id(self, db_session):
        ...
        assert request_1_quotes[0].description == "Request 1 Quote 1"  # Lower cost first
    ...
    def test_find_by_provider_id(self, db_session):
        ...
        other_provider_quote = QuoteFactory.create(
            provider_id=2002,
            description="Other Provider Quote"
        )
        db_session.commit()
    ...
    def test_find_competitive_quotes(self, db_session):
        ...
        competitive_excluding = repo.find_competitive_quotes(1001, exclude_quote_id=quote_1.id)
    ...
    def test_get_provider_quote_stats(self, db_session):
        ...
        assert abs(stats["avg_response_time"] - 1.0) < 0.1  # 1 hour average (with tolerance)
