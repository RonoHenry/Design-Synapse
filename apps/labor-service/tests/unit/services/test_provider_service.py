...
from src.models.service_provider import ServiceProvider, ProviderType, VerificationStatus, Skill, SkillCategory, ProficiencyLevel
...
class TestProviderService:
    ...
    @pytest.mark.asyncio
    async def test_register_provider_success(self, provider_service, mock_provider_repository, sample_provider_data):
    ...
    @pytest.mark.asyncio
    async def test_register_provider_duplicate_user(self, provider_service, mock_provider_repository, sample_provider_data):
        """Test provider registration with duplicate user_id"""
        mock_provider_repository.get_by_user_id.return_value = ServiceProvider(id=1, user_id=1)
        
        with pytest.raises(ValidationError, match="Provider already exists for this user"):
            await provider_service.register_provider(sample_provider_data)

    @pytest.mark.asyncio
    async def test_get_provider_success(self, provider_service, mock_provider_repository):
    ...
    @pytest.mark.asyncio
    async def test_get_provider_not_found(self, provider_service, mock_provider_repository):
    ...
    @pytest.mark.asyncio
    async def test_update_provider_profile(self, provider_service, mock_provider_repository):
    ...
    @pytest.mark.asyncio
    async def test_update_availability(self, provider_service, mock_provider_repository):
    ...
    @pytest.mark.asyncio
    async def test_get_provider_analytics(self, provider_service, mock_provider_repository):
